...
We've set up the initial solution for you for the pizza store app in this repo. Go ahead and clone this repo to your machine or download it as a zip. You'll find the starting point in the **../vsl2021blaze/src/BlazingPizza** folder .
...
- Select the Extensions item on the action bar.

![image](https://user-images.githubusercontent.com/1954458/141712896-86e4f19a-2586-467b-bf88-5ab673034ee4.png)
 
- Install **Microsoft.AspNetCore.Razor.VSCode.BlazorWasmDebuggingExtension**

- Select **File | Open Folder** and navigate to **..\vsl2021blaze\src\BlazingPizza** (where ... is where you copied/cloned the source files.)

- You will want to click **Yes I trust the authors** otherwise you won't be able to run things.

![image](https://user-images.githubusercontent.com/1954458/141712644-7782ff58-94d5-4d9d-b3ed-a2c6757b704d.png)

- When prompted to restore compontents click Restore.

![image](https://user-images.githubusercontent.com/1954458/141713459-873e5996-60cb-4bfc-a192-61bfde3e4436.png)

- Click **Run | Start without debugging**.

It may take a minute or two to launch. Also you will need to allow your browser to "trust" the developer ssl cert.

When you run the app, you'll see that it currently only contains a simple home page. Note you will need to trust the dev SSL certificate.

![image](https://user-images.githubusercontent.com/1874516/77238160-25fa2c80-6b8b-11ea-8145-e163a9f743fe.png)

There's not much to look at so close your brower (or browser tab) and then the "stop the debugger" in VS Code.
